    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 font-sans text-gray-900">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-500 mt-2">Complete the steps below to secure your spot.</p>
        </div>

        {/* Progress Bar (Stepper) */}
    {/* Progress Bar (Stepper) */}
        <div className="mb-16 sm:mb-20"> {/* Increased bottom margin to fit absolute labels */}
                ...
                <React.Fragment key={step.id}>
                  ...
                  <div className="relative flex flex-col items-center">
                    ...
                    <div className="hidden sm:flex absolute top-12 w-32 flex-col items-center text-center">
                      <span className={ ("text-sm font-semibold", isActive ? "text-blue-700" : isCompleted ? "text-gray-900" : "text-gray-400")}>
                        {step.title}
                      </span>
...
function Step1Office() {
  const offices = [
    { id: 1, name: "Regional Transport Office (RTO)", type: "Transport", dist: "2.4 km" },
    { id: 2, name: "Civil Hospital", type: "Healthcare", dist: "4.1 km" },
    { id: 3, name: "Municipal Corporation Center", type: "Civic Services", dist: "5.0 km" },
    { id: 4, name: "Passport Seva Kendra", type: "Identity", dist: "8.2 km" },
  ];

  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <h2 className="text-xl font-bold text-gray-900 mb-6">Select a Government Office</h2>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {offices.map((office) => (
          <label key={office.id} className="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500">
            <input type="radio" name="office" className="sr-only peer" />
            <div className="flex w-full items-center justify-between">
              <div>
                <p className="text-sm text-blue-600 font-medium mb-1">{office.type}</p>
...
function Step2Service() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <p className="text-gray-500 mb-6">Showing services for: <span className="font-medium text-gray-900">Regional Transport Office (RTO)</span></p>
      
      <div className="space-y-3">
        {services.map((service) => (
          <label key={service.id} className="relative flex cursor-pointer rounded-xl border border-gray-200 bg-white p-4 shadow-sm hover:bg-gray-50 transition-colors">
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded-md">Est: {service.time}</span>
...
function Step3Time() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <h2 className="text-xl font-bold text-gray-900 mb-6">Choose a Date & Time</h2>
      
      {/* Date Selection (Mocked as static for UI purposes) */}
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wider">Available Dates</h3>
        <div className="flex gap-3 overflow-x-auto pb-2">
          {["Today", "Tomorrow", "Wed, Oct 24", "Thu, Oct 25"].map((day, i) => (
            <button key={i} className={clsx(
              ...
              i === 0 ? "border-blue-600 bg-blue-50 text-blue-700" : "border-gray-200 bg-white text-gray-700 hover:border-gray-300"
            )}>
              {day}
            </button>
          ))}
      ...
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wider">Available Time Slots</h3>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pb-4 border-b border-gray-200 gap-2">
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">Regional Transport Office (RTO)</p>
          </div>
          <button className="text-sm font-medium text-blue-600 self-start sm:self-center">Edit</button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pb-4 border-b border-gray-200 gap-2">
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">Driving License Renewal</p>
          </div>
          <button className="text-sm font-medium text-blue-600 self-start sm:self-center">Edit</button>
        </div>
      ...
      <div className="mt-6 flex items-start gap-3 bg-blue-50 p-4 rounded-xl text-blue-800 text-sm">
        ...
        <p>Please arrive at the office 10 minutes before your scheduled time. You will receive an SMS alert when your turn is approaching.</p>
      </div>
    </div>
  );
}
...
function Step5Success() {
  return (
    <div className="py-8 text-center animate-in zoom-in-95 duration-500">
      ...
      <p className="text-gray-500 mb-8">Your digital token has been generated successfully.</p>
      ...
      <div className="max-w-xs mx-auto bg-white border-2 border-dashed border-gray-300 rounded-2xl p-6 relative">
        ...
        <p className="text-sm text-gray-500 font-medium uppercase tracking-widest mb-1">Token Number</p>
        <p className="text-5xl font-black text-blue-600 mb-4 tracking-tighter">B-142</p>
      ...
      <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
        ...
        <button className="px-8 py-3 text-gray-700 bg-white border border-gray-300 font-semibold rounded-xl hover:bg-gray-50 transition-colors">
          Go to Dashboard
        </button>
      </div>
    </div>
